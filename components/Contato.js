...
const Contato = forwardRef((props, ref) => {
  ...
  return (
    <div ref={ref} className="min-h-screen flex flex-col">
      ...
      <div className="z-10 rounded-md shadow-md dark:shadow-white p-4 md:p-10 lg:p-20 max-w-6xl mx-auto mb-20 mt-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="md:ml-4">
            <header className="">
              <h1 className="dark:text-gray-300 text-gray-700 font-semibold text-2xl">
                Estes são meus meios de contato:
              </h1>
              <p className="font-light text-base dark:text-gray-300 text-black mt-2">
                Mande uma mensagem para mim! Responderei o mais breve possível.
              </p>
            </header>
            <div className="icons-container inline-flex flex-col my-20">
              ...
              <motion.div
                ...
                transition={{ duration: 0.8, ease: "easeInOut" }}
              >
                <button className=" rounded-lg w-60">
                  <a
                  ...
                  >
                    <div className="flex flex-row items-center space-x-6 rounded-md border border-[#02044A] hover:border hover:border-blue-500 p-4">
                      ...
                      <p className="mx-3 ml-6">Linkedin</p>
                      <FaExternalLinkAlt />
                    </div>
                  </a>
                </button>
              ...
              >
                ...
                >
                  <div className="flex flex-row items-center space-x-6 rounded-md border border-[#02044A] hover:border hover:border-blue-500 p-4">
                    ...
                    <p className="mx-3 ml-6">GitHub</p>
                    <FaExternalLinkAlt />
                  </div>
                </a>
              </motion.div>
