...
const Contato = forwardRef((props, ref) => {
  return (
    <div ref={ref} className="min-h-screen flex flex-col">
      ...
      <div className="z-10 rounded-md shadow-md p-4 md:p-10 lg:p-20 max-w-6xl mx-auto mb-20 mt-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="md:ml-4">
            <header className="">
              <h1 className="dark:text-gray-300 text-black font-semibold text-2xl">
